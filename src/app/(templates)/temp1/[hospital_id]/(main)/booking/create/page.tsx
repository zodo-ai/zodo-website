  ...
  const createBooking = async () => {
    ...
    try {
      ...
      const doctorPayload: CreateDoctorBookingPayload = {
        ...
        successCallback: `${origin}/temp1/${hospital_id}/booking/success?type=${bookingType}`,

        errorCallback: `${origin}/temp1/${hospital_id}/booking/cancel?type=${bookingType}`,
      };
  ...
  return (
    <main className="min-h-screen bg-white px-4 py-10 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px]">
          <section className="space-y-5 rounded-lg border border-[color-mix(in_srgb,var(--primary-color)_20%,white)] bg-white p-5 shadow-sm md:p-6">
            <div className="flex flex-col gap-4 border-b border-[color-mix(in_srgb,var(--primary-color)_15%,white)] pb-5 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <p className="flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-[var(--primary-color)]">
                  {
                    bookingType === "doctor" ? (
                      <Stethoscope size={16} />
                    ) : (
                ...
                <h1 className="mt-2 text-2xl font-bold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">
                  {bookingType === "doctor"
              ...
              <div className="flex w-fit items-center gap-2 rounded-md bg-[color-mix(in_srgb,var(--primary-color)_10%,white)] px-3 py-2 text-sm font-semibold text-[var(--primary-color)]">
                {
                  bookingType === "doctor" ? (
                    <Stethoscope size={16} />
                  ) : (
            ...
            <div className="rounded-lg border border-[color-mix(in_srgb,var(--primary-color)_15%,white)] bg-[color-mix(in_srgb,var(--primary-color)_5%,white)] p-4">
              <p className="text-xs font-semibold uppercase text-gray-500">
                Selected
              </p>
              <p className="mt-1 flex items-center gap-2 font-semibold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">
          ...
          <aside className="h-fit space-y-4 rounded-lg border border-[color-mix(in_srgb,var(--primary-color)_20%,white)] bg-white p-5 shadow-sm md:p-6">
            <div>
              <h2 className="flex items-center gap-2 text-xl font-bold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">
                <CreditCard size={20} />
                Payment Summary
              </h2>
              <p className="mt-2 text-sm text-gray-500">
            ...
            <div className="space-y-3 rounded-lg bg-[color-mix(in_srgb,var(--primary-color)_5%,white)] p-4 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">
              ...
              <div className="border-t border-[color-mix(in_srgb,var(--primary-color)_20%,white)] pt-3">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">Total</span>
                  <span className="flex items-center gap-1 text-xl font-bold text-[color-mix(in_srgb,var(--primary-color)_80%,black)]">
                    <IndianRupee size={18} />
            ...
            <div className="space-y-3 rounded-lg border border-[color-mix(in_srgb,var(--primary-color)_15%,white)] p-4">
              <label
                htmlFor="coupon"
              ...
              <div className="flex gap-2">
                ...
                {appliedCoupon ? (
                  ...
                  <Button
                    ...
                    className="hover:opacity-90 cursor-pointer h-10"
                    style={{ backgroundColor: "var(--primary-color)", color: "white" }}
                  >
                    {couponLoading ? "..." : "Apply"}
                  </Button>
              ...
              {appliedCoupon && (
                <p className="flex items-center gap-2 text-sm font-medium text-[var(--primary-color)]">
            ...
            <div className="rounded-lg border border-[color-mix(in_srgb,var(--primary-color)_15%,white)] p-4 relative">
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-[var(--primary-color)] hover:text-[var(--primary-color)] transition-colors cursor-pointer"
                >
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {selectedPatient?.relation && (
                  <span className="inline-flex items-center rounded-sm bg-[color-mix(in_srgb,var(--primary-color)_10%,white)] px-2 py-1 text-xs font-semibold uppercase tracking-wider text-[var(--primary-color)]">
                    {selectedPatient.relation}
                  </span>
                )}
              </div>
            ...
            <Button
              type="button"
              className="h-11 w-full rounded-full font-semibold hover:opacity-90 cursor-pointer"
              style={{ backgroundColor: "var(--primary-color)", color: "white" }}
