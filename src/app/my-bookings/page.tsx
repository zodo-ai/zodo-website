    ...
    <main className="min-h-screen bg-[#F6FAF9] px-4 py-10 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            variant="outline"
            className="w-fit gap-2 border-[#B7D5D0] text-[#1D453F]"
            onClick={refresh}
            disabled={loading}
          >
        ...
        <Card className="rounded-lg border-[#E0ECE9] shadow-sm">
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="rounded-lg border border-dashed border-[#C9DCD8] bg-[#F8FBFA] p-10 text-center">
                <p className="font-semibold text-[#173F3A]">No bookings yet</p>
                <p className="mt-2 text-sm text-[#6B7C80]">
        ...
        {!loading && !error && totalPages > 1 && (
          <nav className="flex flex-wrap items-center justify-center gap-2">
            <Button
              variant="outline"
              className="gap-2 border-[#B7D5D0] text-[#1D453F]"
            ...
            {pageNumbers.map((page) => (
              <Button
                ...
                className={
                  page === currentPage
                    ? "bg-[#1D453F] hover:bg-[#173A35]"
                    : "border-[#B7D5D0] text-[#1D453F]"
                }
